...
class ProjectManagerUI:
    ...
    def _render_new_project_dialog(self, x: int, y: int, width: int, height: int):
        ...
        self.ui.label(
            self.new_project_name if self.new_project_name else "Enter project name...",
            dialog_x + 40,
            current_y + 10,
            size=16,
            color=(255, 255, 255) if self.new_project_name else (120, 120, 120),
        )
        ...
        for template_id, template_name in templates.items():
            ...
            if self.ui.button(
                template_name, dialog_x + 30, current_y, 250, 35, color=template_color
            ):
    ...
    def _render_scenes_view(self, x: int, y: int, width: int, height: int):
        ...
        # Header
        self.ui.label(
            f"Scenes - {self.selected_project}",
            x + 20,
            y + 10,
            size=20,
            color=(200, 200, 255),
        ...
        if not self.scenes:
            self.ui.label(
                "No scenes found. Create a new scene!",
                x + width // 2 - 120,
                y + height // 2,
                size=16,
                color=(150, 150, 150),
        ...
        for scene_name in self.scenes:
            ...
            # Load button
            if self.ui.button(
                "Load", x + width - 250, current_y + 12, 100, 35, color=(0, 100, 150)
            ):
                self.load_scene(scene_name)

            # Delete button
            if self.ui.button(
                "Delete", x + width - 140, current_y + 12, 100, 35, color=(150, 0, 0)
            ):
    ...
    def _render_saves_view(self, x: int, y: int, width: int, height: int):
        ...
        # Header
        self.ui.label(
            f"Save Files - {self.selected_project}",
            x + 20,
            y + 10,
            size=20,
            color=(200, 200, 255),
        ...
        for save_data in self.save_files:
            ...
            if self.ui.button(
                "Delete", x + width - 140, current_y + 17, 100, 35, color=(150, 0, 0)
            ):
